...
const TEAM: Member[] = [
  ...
  {
    name: "Sanjana Bathrinarayanan",
    role: "Chief Executive Officer",
    initials: "SB",
    photo: "/team/sanjana.png",
    bio: "Driving the vision and direction of OpenSourceMate.",
    tags: ["CEO", "Strategy", "Leadership"],
    linkedin: "https://www.linkedin.com/in/sanjanabathrinarayanan-1929b3379",
  },
  {
    name: "Dhivashya",
    role: "Co-founder",
    initials: "DH",
    photo: "/team/dhivashya.png",
    bio: "Co-architecting the product from day one.",
    tags: ["Co-founder", "Product"],
    linkedin: "https://www.linkedin.com/in/diva-david-415297382",
  },
  {
    name: "Harshini Devi",
    role: "Chief Technology Officer",
    initials: "HD",
    photo: "/team/harshini.png",
    bio: "Owns the platform — infra, scale, and the engineering bar.",
    tags: ["CTO", "Architecture", "Engineering"],
    linkedin: "https://www.linkedin.com/in/harshinidevi-rajkumar-40029a382",
  },
  {
    name: "Ilakiya M",
    role: "Chief Operating Officer",
    initials: "IM",
    photo: "/team/ilakiya.png",
    bio: "Makes the team move fast and ship reliably.",
    tags: ["COO", "Operations"],
    linkedin: "https://www.linkedin.com/in/ilakiya-muthukumar-a484b1373",
  },
  {
    name: "Trisha Didwania",
    role: "AI Engineer",
    initials: "TD",
    photo: "/team/trisha.png",
    bio: "Tunes the models that read your codebase.",
    tags: ["AI/ML", "LLMs", "Embeddings"],
    linkedin: "https://www.linkedin.com/in/trisha-didwania-3bb719387",
  },
  {
    name: "Pradnya Lakshmi J R",
    role: "Lead Frontend Developer",
    initials: "PL",
    photo: "/team/pradnya.png",
    bio: "Crafts the experience pixel by pixel.",
    tags: ["Frontend", "Next.js", "TypeScript"],
    linkedin: "https://www.linkedin.com/in/pradnya-lakshmi-j-r-2312b035b",
  },
  {
    name: "Shubhangi Srivastava",
    role: "UI / UX Lead",
    initials: "SS",
    photo: "/team/shubhangi.png",
    bio: "Turning AI complexity into a calm interface.",
    tags: ["UX", "UI", "Design systems"],
    linkedin: "https://www.linkedin.com/in/shubhangi-srivastava-46a43b368",
  },
];
